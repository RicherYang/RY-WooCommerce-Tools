...
return [
    ...
    [
        ...
        'id' => Main::get_prefix_name('smilepay_shipping_log'),
        'type' => 'checkbox',
        'default' => 'no',
    ...
    [
        ...
        'id' => Main::get_prefix_name('smilepay_shipping_log_status_change'),
        'type' => 'checkbox',
        'default' => 'no',
    ...
    [
        ...
        'id' => Main::get_prefix_name('smilepay_shipping_auto_order_status'),
        'type' => 'checkbox',
        'default' => 'yes',
    ...
    [
        ...
        'id' => Main::get_prefix_name('smilepay_shipping_auto_get_no'),
        'type' => 'checkbox',
        'default' => 'yes',
    ...
    [
        ...
        'id' => Main::get_prefix_name('smilepay_shipping_apiinfo[itemname]'),
        'type' => 'text',
        'default' => '',
    ...
    [
        ...
        'id' => Main::get_prefix_name('smilepay_shipping_cvs_type'),
        'type' => 'select',
        'default' => 'C2C',
        'options' => [
    ...
    [
        ...
        'id' => Main::get_prefix_name('smilepay_shipping_apiinfo[print]'),
        'type' => 'select',
        'default' => '2',
        'options' => [
    ...
    [
        ...
        'id' => Main::get_prefix_name('smilepay_shipping_apiinfo[delivery_date]'),
        'type' => 'select',
        'default' => '1',
        'options' => [
