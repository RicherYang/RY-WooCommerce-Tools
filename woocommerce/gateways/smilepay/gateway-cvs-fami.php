...
class RY_SmilePay_Gateway_Cvs_Fami extends RY_WT_WC_SmilePay_Payment_Gateway
{
    ...
    public function process_admin_options()
    {
        ...
        if (isset($this->data['woocommerce_ry_smilepay_cvs_fami_expire_date'])) {
            $this->data['woocommerce_ry_smilepay_cvs_fami_expire_date'] = (int) $this->data['woocommerce_ry_smilepay_cvs_fami_expire_date'];
            if ($this->data['woocommerce_ry_smilepay_cvs_fami_expire_date'] < 120 || $this->data['woocommerce_ry_smilepay_cvs_fami_expire_date'] > 10080) {
                $this->data['woocommerce_ry_smilepay_cvs_fami_expire_date'] = 4320;
