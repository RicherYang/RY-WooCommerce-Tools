...
class RY_PAYUNi_Gateway_Atm extends RY_WT_WC_PAYUNi_Payment_Gateway
{
    ...
    public function __construct()
    {
        ...
        add_filter('ry_admin_payment_info-ry_payuni_atm', [$this, 'show_payment_info'], 10, 2);
    }

    public function process_admin_options()
    {
        if (isset($_POST['woocommerce_ry_payuni_atm_expire_date'])) { // phpcs:ignore WordPress.Security.NonceVerification.Missing
            $_POST['woocommerce_ry_payuni_atm_expire_date'] = intval($_POST['woocommerce_ry_payuni_atm_expire_date']); // phpcs:ignore WordPress.Security.NonceVerification.Missing
            if ($_POST['woocommerce_ry_payuni_atm_expire_date'] < 1 || $_POST['woocommerce_ry_payuni_atm_expire_date'] > 180) { // phpcs:ignore WordPress.Security.NonceVerification.Missing
                $_POST['woocommerce_ry_payuni_atm_expire_date'] = 3; // phpcs:ignore WordPress.Security.NonceVerification.Missing
