...
return [
    ...
    [
        ...
        'id' => RY_WT::PREFIX . 'payuni_gateway_log',
        'type' => 'checkbox',
        'default' => 'no',
    ...
    [
        ...
        'id' => RY_WT::PREFIX . 'payuni_gateway_apiinfo[prefix]',
        'type' => 'text',
    ...
    [
        ...
        'id' => RY_WT::PREFIX . 'payuni_gateway_apiinfo[item_name]',
        'type' => 'text',
        'default' => '',
    ...
    [
        ...
        'id' => RY_WT::PREFIX . 'payuni_gateway_apiinfo[testmode]',
        'type' => 'checkbox',
        'default' => 'no',
    ...
    [
        ...
        'id' => RY_WT::PREFIX . 'payuni_gateway_apiinfo[MerID]',
        'type' => 'text',
        'default' => '',
        'autoload' => false,
    ],
    [
        ...
        'id' => RY_WT::PREFIX . 'payuni_gateway_apiinfo[HashKey]',
        'type' => 'text',
        'default' => '',
        'autoload' => false,
    ],
    [
        ...
        'id' => RY_WT::PREFIX . 'payuni_gateway_apiinfo[HashIV]',
        'type' => 'text',
        'default' => '',
        'autoload' => false,
    ],
