...
final class RY_WT_WC_PAYUNi_Gateway_Admin
{
    ...
    public static function instance(): RY_WT_WC_PAYUNi_Gateway_Admin
    {
    ...
    protected function do_init(): void
    {
        ...
        add_action('woocommerce_update_options_rytools_payuni_gateway', [$this, 'check_option']);
    }

    public function add_sections($sections)
    {
        $sections['payuni_gateway'] = __('PAYUNi gateway options', 'ry-woocommerce-tools');
    ...
    public function check_option()
    {
        if (!preg_match('/^[a-z0-9]*$/i', RY_WT::get_option('payuni_gateway_order_prefix'))) {
            ...
            RY_WT::update_option('payuni_gateway_order_prefix', '');
        }
    }
}
