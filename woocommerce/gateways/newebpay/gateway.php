...
final class RY_WT_WC_NewebPay_Gateway extends RY_WT_Gateway_Model
{
    private static ?self $_instance = null;

    protected string $model_type = 'newebpay_gateway';
    ...
    {
        $api_info = Main::get_option('newebpay_gateway_apiinfo', []);
