...
class RY_WT_WC_NewebPay_Gateway_Api extends RY_WT_WC_NewebPay_Api
{
    ...
    {
        RY_WT_WC_NewebPay_Gateway::instance()->log('Generating payment form by ' . $gateway->id . ' for #' . $order->get_order_number());
        ...
        RY_WT_WC_NewebPay_Gateway::instance()->log('Checkout POST: ' . var_export($form_data, true));
        RY_WT_WC_NewebPay_Gateway::instance()->log('Checkout POST TradeInfo: ' . var_export($args, true));
