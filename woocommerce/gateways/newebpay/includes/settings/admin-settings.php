...
return [
    ...
    [
        ...
        'id' => Main::get_prefix_name('newebpay_gateway_log'),
        'type' => 'checkbox',
        'default' => 'no',
    ...
    [
        ...
        'id' => Main::get_prefix_name('newebpay_gateway_apiinfo[prefix]'),
        'type' => 'text',
    ...
    [
        ...
        'id' => Main::get_prefix_name('newebpay_gateway_apiinfo[item_name]'),
        'type' => 'text',
        'default' => '',
    ...
    [
        ...
        'id' => Main::get_prefix_name('newebpay_gateway_apiinfo[testmode]'),
        'type' => 'checkbox',
        'default' => 'no',
    ...
    [
        ...
        'id' => Main::get_prefix_name('newebpay_gateway_apiinfo[MerchantID]'),
        'type' => 'text',
        'default' => '',
        'autoload' => false,
    ],
    [
        ...
        'id' => Main::get_prefix_name('newebpay_gateway_apiinfo[HashKey]'),
        'type' => 'text',
        'default' => '',
        'autoload' => false,
    ],
    [
        ...
        'id' => Main::get_prefix_name('newebpay_gateway_apiinfo[HashIV]'),
        'type' => 'text',
        'default' => '',
        'autoload' => false,
    ],
