...
class RY_NewebPay_Gateway_Barcode extends RY_WT_WC_NewebPay_Payment_Gateway
{
    ...
    public function process_admin_options()
    {
        ...
        if (isset($this->data['woocommerce_ry_newebpay_barcode_expire_date'])) {
            $this->data['woocommerce_ry_newebpay_barcode_expire_date'] = (int) $this->data['woocommerce_ry_newebpay_barcode_expire_date'];
            if ($this->data['woocommerce_ry_newebpay_barcode_expire_date'] < 1 || $this->data['woocommerce_ry_newebpay_barcode_expire_date'] > 180) {
                $this->data['woocommerce_ry_newebpay_barcode_expire_date'] = 7;
