...
<table>
    <tr>
        ...
        <td><?=$order->get_meta('_ecpay_barcode_Barcode1') ?>
        </td>
    </tr>
    <tr>
        <td><?=__('Barcode 2', 'ry-woocommerce-tools') ?>
        </td>
        <td><?=$order->get_meta('_ecpay_barcode_Barcode2') ?>
        </td>
    </tr>
    <tr>
        <td><?=__('Barcode 3', 'ry-woocommerce-tools') ?>
        </td>
        <td><?=$order->get_meta('_ecpay_barcode_Barcode3') ?>
        </td>
    </tr>
    <tr>
        <td><?=__('Payment deadline', 'ry-woocommerce-tools') ?>
        </td>
        <td><?=$order->get_meta('_ecpay_barcode_ExpireDate') ?>
        </td>
    </tr>
</table>
<?php
