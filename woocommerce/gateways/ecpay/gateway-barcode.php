...
class RY_ECPay_Gateway_Barcode extends RY_WT_WC_ECPay_Payment_Gateway
{
    ...
    {
        if (isset($_POST['woocommerce_ry_ecpay_barcode_expire_date'])) { // phpcs:ignore WordPress.Security.NonceVerification.Missing
            $_POST['woocommerce_ry_ecpay_barcode_expire_date'] = intval($_POST['woocommerce_ry_ecpay_barcode_expire_date']); // phpcs:ignore WordPress.Security.NonceVerification.Missing
            if ($_POST['woocommerce_ry_ecpay_barcode_expire_date'] < 1 || $_POST['woocommerce_ry_ecpay_barcode_expire_date'] > 30) { // phpcs:ignore WordPress.Security.NonceVerification.Missing
                $_POST['woocommerce_ry_ecpay_barcode_expire_date'] = 7; // phpcs:ignore WordPress.Security.NonceVerification.Missing
