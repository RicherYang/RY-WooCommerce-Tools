...
$order_info = [
    'barcode1' => $order->get_meta('_smilepay_barcode_Barcode1'),
    'barcode2' => $order->get_meta('_smilepay_barcode_Barcode2'),
    'barcode3' => $order->get_meta('_smilepay_barcode_Barcode3'),
