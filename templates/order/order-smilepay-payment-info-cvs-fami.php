<?php
/**
 * This template can be overridden by copying it to yourtheme/woocommerce/order/order-smilepay-payment-info-cvs-fami.php
 *
...
if ('ry_smilepay_cvs_fami' !== $order->get_payment_method()) {
    return;
}

if ('6' !== $order->get_meta('_smilepay_payment_type')) {
    return;
}
?>
