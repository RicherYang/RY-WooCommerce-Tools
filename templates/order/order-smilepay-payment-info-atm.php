...
if ('ry_smilepay_atm' !== $order->get_payment_method()) {
    return;
}

if ('2' !== $order->get_meta('_smilepay_payment_type')) {
    return;
}
?>
    ...
    <table class="woocommerce-table woocommerce-table--payment-details payment_details">
        <tbody>
            <tr>
                ...
                <td>
                    <?php echo esc_html(_x($order->get_meta('_smilepay_atm_BankCode'), 'Bank code', 'ry-woocommerce-tools')); ?>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <?php echo wordwrap(esc_html($order->get_meta('_smilepay_atm_vAccount')), 4, '<span> </span>', true); ?>
                </td>
            </tr>
            <tr>
                <td>
